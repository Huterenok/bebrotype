...
#[derive(Serialize, Deserialize, Debug, ErrorResponse)]
...
pub enum Error {
    ...
    #[error(
        code = 400,
        msg = "User update form must contain: avatar | near_address"
    )]
    ...
    #[error(code = 404, msg = "Couldn't find any texts by {} user id")]
    TextsByUserIdNotFound(i64),
